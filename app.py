...
@app.route('/')
def home():
    return "I'am Live File Hosting Bot"
...
# --- Configuration ---
TOKEN = '8520183612:AAFb5W6OuFpwAIgxNRhS1C5i2uZHSCInBTI' # Replace with your actual token
OWNER_ID = 1926956969 # Replace with your Owner ID
ADMIN_ID = 5330000777 # Replace with your Admin ID (can be same as Owner)
YOUR_USERNAME = '@jubayer3501' # Replace with your Telegram username (without the @)
UPDATE_CHANNEL = 'https://t.me/fflikebd' # Replace with your update channel link
